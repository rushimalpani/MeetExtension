...
import { getAuthUrl, saveToken } from '../services/api';
  ...
  return (
    <div className="auth-section">
      <div className="auth-card">
        <img src="/icon128.png" alt="Auth" className="auth-logo" />
        <h2>Connect Your Google Account</h2>
        <p>Sign in with Google to create calendar events and generate Meet links.</p>
